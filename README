...
STEP 1.2:
     ...
     A shell script program is provided under the name "ElaStic_WIEN2k_init.sh" which allows you 
     ...
     You find FLAGS of "WIEN2k_init_lapw_silent.csh" program if you write following command in terminal:

     $ csh WIEN2k_init_lapw_silent.csh -H

     Once the WIEN2k calculations are finished, you can run the following scripts to save and clean
     your calculations.
    
     $ csh ElaStic_Save_Clean_WIEN2k.csh
