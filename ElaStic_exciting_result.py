...
if (mthd == 'Energy' and ordr == 2): subprocess.run(['ElaStic_Result_Energy_2nd.py'], check=True)
if (mthd == 'Energy' and ordr == 3): subprocess.run(['ElaStic_Result_Energy_3rd.py'], check=True)
